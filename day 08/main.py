...
if not GEMINI_API_KEY:
    print("Warning: GEMINI_API_KEY not found in .env file. The LLM endpoint will not function.")
...
async def llm_query(text: str = Form(...)):
    """
    accepts text input and returns a response generated by the Gemini.
    """
    if not GEMINI_API_KEY:
